...
Returns:
  ...
  async (params: { code: string; timeout: number }) => {
...
Returns:
  ...
  async (params: { code: string; input: string; timeout: number }) => {
...
Returns:
  ...
  async (params: { package: string; upgrade: boolean }) => {
