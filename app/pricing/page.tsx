    ...
    <div className="min-h-screen" style={{ backgroundColor: '#e0f2fe' }}>
      ...
      <section className="max-w-5xl mx-auto px-4 py-16 text-center">
        ...
        <div className="flex items-center justify-center gap-4 mb-12">
          <span className={`text-sm ${!isAnnual ? 'text-slate-800' : 'text-slate-600'}`}>Monthly</span>
          <button
            onClick={() => setIsAnnual(!isAnnual)}
            className={`relative w-14 h-7 rounded-full transition ${
              isAnnual ? 'bg-gradient-to-r from-[#38bdf8] to-[#60a5fa]' : 'bg-slate-300'
            }`}
          >
            <span
          ...
          <span className={`text-sm ${isAnnual ? 'text-slate-800' : 'text-slate-600'}`}>
            Annual <span className="text-slate-600 text-xs">(Save 20%)</span>
          </span>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* Free Tier */}
          <div className="rounded-2xl p-8 border border-slate-300 text-left shadow-sm" style={{ backgroundColor: '#79B4EE' }}>
            <div className="mb-6">
            ...
            <Link
              href="/"
              className="block w-full py-3 text-center bg-white hover:bg-slate-50 text-slate-800 font-semibold rounded-lg transition border border-slate-300 shadow-sm"
            >
              Get Started Free
            </Link>
          </div>
          ...
          {/* Pro Tier */}
          <div className="rounded-2xl p-8 border-2 border-[#38bdf8] text-left relative overflow-hidden shadow-lg" style={{ backgroundColor: '#79B4EE' }}>
            {/* Popular badge */}
            <div className="absolute top-4 right-4 px-3 py-1 bg-gradient-to-r from-[#38bdf8] to-[#60a5fa] text-white text-xs font-semibold rounded-full">
              RECOMMENDED
            </div>
            ...
            <button
              ...
              className="block w-full py-3 text-center bg-gradient-to-r from-[#38bdf8] to-[#60a5fa] hover:from-[#60a5fa] hover:to-[#38bdf8] text-white font-semibold rounded-lg transition shadow-md"
            >
              Contact Sales
            </button>
          </div>
          ...
          <div className="space-y-6">
            <div className="rounded-xl p-6 border border-slate-300 shadow-sm bg-white">
              ...
              <p className="text-slate-700 text-sm">
                ...
                You'll get instant insights on content structure, brand ranking, website technical, keyword visibility, and AI trust signals.
              </p>
            </div>
